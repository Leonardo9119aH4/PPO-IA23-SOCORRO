...
export function loadLoop(varinputcommand: string, inputlist: Array<string>, line: number, commandsjson: Array<Commands>, gameVars: Array<Array<string>>, phaserCommands: Array<Array<string>>) {
    console.log(inputlist)
    let loopcommands: Array<string> = listCommands(inputlist, line, line)[0]
    while(eval(expressionString)){
        load(loopcommands, commandsjson, gameVars, phaserCommands)
